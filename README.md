...
и скачать от туда Docker (в случае если у вас система MAC, Windows, в ином установка посредством терминала).
...
Для более легкого просмотра возможностей проекта (пока не клиента) вы можете прейти по ссылке:
